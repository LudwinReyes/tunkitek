  ...
  const funnelServices: FunnelService[] = [
    {
      ...
      imageAlt: 'Ingenieros de software en TunkiTek desarrollando tiendas e-commerce de alto rendimiento y sitios web corporativos',
    ...
    },
    {
      ...
      imageAlt: 'Arquitecto de software senior monitoreando infraestructura cloud, microservicios y plataformas SaaS a medida en TunkiTek',
    ...
    },
    {
      ...
      imageAlt: 'Demostración de automatización de procesos empresariales y agentes de WhatsApp con IA en smartphone y laptop',
